...
CREATE TABLE "new_SiteSettings" (
    ...
    "logoUrl" TEXT,
    "faviconUrl" TEXT,
    "siteDescription" TEXT NOT NULL DEFAULT 'Butakia es la plataforma colaborativa para ver películas y series online gratis, en HD y en español latino.',
    "secondaryColor" TEXT NOT NULL DEFAULT '#161616',
    "bannerUrl" TEXT,
    "bannerLink" TEXT,
...
INSERT INTO "new_SiteSettings" ("accentColor", "adsEnabled", "allowGuestPlayback", "donationSharePercent", "donationsEnabled", "fakeVisitorsEnabled", "fakeVisitorsMax", "fakeVisitorsMin", "id", "librosHeroMessage", "librosTagline", "maxProfilesFree", "paypalLink", "pdfUploadEnabled", "premiumEnabled", "premiumPriceMonthly", "prerollEnabled", "profilesPremiumOnly", "requireApproval", "siteName", "siteTagline", "thankYouMessage", "totalDonations", "uploadGoal", "yapeNumber", "yapeQrUrl") SELECT "accentColor", "adsEnabled", "allowGuestPlayback", "donationSharePercent", "donationsEnabled", "fakeVisitorsEnabled", "fakeVisitorsMax", "fakeVisitorsMin", "id", "librosHeroMessage", "librosTagline", "maxProfilesFree", "paypalLink", "pdfUploadEnabled", "premiumEnabled", "premiumPriceMonthly", "prerollEnabled", "profilesPremiumOnly", "requireApproval", "siteName", "siteTagline", "thankYouMessage", "totalDonations", "uploadGoal", "yapeNumber", "yapeQrUrl" FROM "SiteSettings";
