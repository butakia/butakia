    ...
    <>
      ...
      <main className="flex-1 px-6 pb-16 pt-28 md:px-10">
        <div className="mx-auto max-w-4xl">
          ...
          <NewThreadForm isLoggedIn={Boolean(user)} section="books" threadBasePath="/libros/foro" />

          <ForumThreadList threads={threads} section="books" threadBasePath="/libros/foro" />
        </div>
      </main>
      <Footer />
    </>
