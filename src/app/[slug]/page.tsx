...
export default async function BookPage({
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Libros", item: `${SITE_URL}` },
      { "@type": "ListItem", position: 3, name: book.title, item: `${SITE_URL}/${book.slug}` },
    ],
  };
      ...
      <main className="flex-1 px-6 pb-16 pt-28 md:px-10">
        <div className="mx-auto flex max-w-5xl flex-col gap-8 md:flex-row">
          <div className="mx-auto aspect-[2/3] w-48 shrink-0 overflow-hidden rounded-xl shadow-2xl md:mx-0 md:w-64">
            <PosterPlaceholder seed={book.cover || book.slug} title={book.title} />
          </div>
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-2 text-white/70">
              ...
              {book.literaryAuthorSlug ? (
                <Link
                  href={`/autor/${book.literaryAuthorSlug}`}
